...
export const PropertyDetailsContent = () => {
  return(
      <div className={"w-full base-page-space"}>
        <div className={"flex justify-center items-center h-[861px]"}>
            <div className={"w-full h-full pr-5"}>
                ...
                <div className={"w-full h-[500px] rounded-[10px] mt-5 overflow-hidden"}>
                    <img src={ThemeUtil.image.daniel} alt={"andrea"} className={"w-full h-full"} />
                </div>
                <div className={"w-full h-[150px] mt-2 flex gap-2 items-center"}>

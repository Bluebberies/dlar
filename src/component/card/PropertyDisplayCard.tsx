        ...
        <div className={"h-[300px] overflow-hidden rounded-[12px] relative"}>
            ...
            <BaseAvatar containerStyle={{
                ...
                <div className={"flex justify-center items-center gap-1 h-full rounded-[12px] "}>
                    <img src={ThemeUtil.icon.cameraOutline} className={"w-[20px] h-[20px]"} alt={"andrea"} />
                    <span>
                        {item.image.length}
                    </span>
                </div>
          ...
          <div className={"mt-5"}>
              ...
              <div className={"flex justify-between items-center"}>
                  ...
                  <img src={ThemeUtil.icon.bookmarkOutline} className={"text-blackColor ml-28 w-[24px] h-[24px]"} alt={"bookmark"} />
              </div>

...
import MobileReadIcon from "@/component/icons/MobileReadIcon";
import NairaIcon from "@/component/icons/NairaIcon";
      ...
      {isTabletOrMobile && (
        <div className="absolute top-0 flex justify-between right-0 items-center w-5/6 py-5 px-8">
          <div className="flex items-center gap-3">
            <img src={ThemeUtil.icon.profile} alt="" width="50px" height="50px" />
            <div>
              <h3>Mr Anthony</h3>
              <p className="text-grayColor_1 text-sm">Online</p>
            </div>
          ...
          <div className="relative flex flex-col justify-end items-end">
            ...
            {menuIsOpen && (
              ...
              >
                ...
                <button className="cursor-pointer text-lg font-bold text-dangerColor">
                  Report Agent
                </button>
              </div>
            )}
          ...
          <div className="flex items-center md:gap-4 gap-2 bg-[#fafafa] md:shadow-lg mt-1 md:px-6 px-2 py-4 sm:w-[97%] mx-auto w-full">
            ...
            <div>
              ...
              <div className="flex items-center relative">
                ...
                <h3 className="text-grayColor_1 pl-1">Per year</h3>
              </div>
            </div>
          </div>
          {/* Messages */}
          <div className="pt-8 px-4 md:px-16 md:pb-64 overflow-y-auto">
            <div className="clear-both float-right my-4 md:my-8">
              ...
              {isTabletOrMobile && (
                <div className="flex items-center gap-2 justify-end">
                  <MobileReadIcon />
                  <span className="text-grayColor_1 text-sm">12:40 pm</span>
                </div>
              )}
            </div>

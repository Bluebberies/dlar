...
const Notifications = () => {
  ...
  return (
    <div className=" h-auto mt-10 lg:pt-8 pb-28 lg:mb-0 bg-white lg:bg-accent5">
        ...
        <div className="w-full sm:w-10/12 lg:w-8/12 mx-auto">
          ...
          <div className="lg:bg-white mb-4">
            ...
            <NotificationCard
              ...
              date={moment().fromNow()}
              imgSrc={ThemeUtil.icon.profile}
            />
            <NotificationCard
              subject="Geraldo"
              message="Just giving 5 Star review on your listing Kings Apartment"
              date={moment().fromNow()}
              imgSrc={ThemeUtil.image.pool_view1}
              appartmentImgSrc={ThemeUtil.image.pool_view1}
              isUnread={true}
            />
            <NotificationCard
              subject="Emmett Perry"

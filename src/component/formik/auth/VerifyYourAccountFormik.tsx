...
export const VerifyYourAccountFormik = () => {
  ...
  function handleVerify() {
    navigate(
      `${RouterConstantUtil.routes.page.baseEmailVerificationSuccessful}/${userId}`
    );
  }
  ...
  return (
    <div className={"mt-[40px] w-[90%] py-4"}>
      ...
      <div className={"w-full flex items-center justify-end"}>
        <p
          className={
            "text-grayColor_1 text-[16px] leading-[20px] text-center cursor-pointer"
          }
        >
          Code expires{" "}
      ...
      <p
        className={
          "text-blackColor mt-10 text-[20px] leading-[20px] text-center cursor-pointer font-darkerGrotesque-bold"
        }
      >
        Click here{" "}
        <span className={"text-grayColor_1 font-darkerGrotesque-medium"}>

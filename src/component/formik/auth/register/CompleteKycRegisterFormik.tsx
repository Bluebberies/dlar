...
export const CompleteKycRegisterFormik = () => {
  ...
  function handleFinish() {
    navigate(RouterConstantUtil.routes.page.home, {
      state: {
        ...
        subtitle:
          "You have successfully set up your marketplace, please log in to start selling properties.",
      },
    });
  }
  ...
  return (
    <div className={"w-[90%] mt-[1rem]"}>
      ...
      <p
        className={
          "max-[425px]:hidden text-grayColor_1 text-[18px] text-center cursor-pointer"
        }
        onClick={handleRegisterNavigate}
      >
        Already have an account?{" "}
        <span className={"text-blackColor"}>Login</span>
      </p>
    </div>
  );
};

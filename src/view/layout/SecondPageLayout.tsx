  ...
  >
      ...
      <div className={"base-page-background"}>
          <div className={"w-[1440px] m-auto"}>
              <BasePageHeader />
              <div className={"flex items-center gap-3 w-full base-page-space mt-16 cursor-pointer"} onClick={handleBack}>
                  <img src={ThemeUtil.icon.arrowLeft} alt={"arrow left"} />
                  <span className={"text-[20px] leading-[35px] font-darkerGrotesque-bold"}>Back</span>
              </div>
              {children}
          </div>
          <BasePageFooter />
